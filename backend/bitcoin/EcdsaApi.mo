...
module {
  type ECDSAPublicKey = BitcoinType.ECDSAPublicKey;
  type ECDSAPublicKeyReply = BitcoinType.ECDSAPublicKeyReply;
  type SignWithECDSA = BitcoinType.SignWithECDSA;
  type SignWithECDSAReply = BitcoinType.SignWithECDSAReply;
