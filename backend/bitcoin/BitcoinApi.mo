...
module {
  type Cycles = BitcoinType.Cycles;
  type Satoshi = BitcoinType.Satoshi;
  type Network = BitcoinType.Network;
  type BitcoinAddress = BitcoinType.BitcoinAddress;
  type GetUtxosResponse = BitcoinType.GetUtxosResponse;
  type MillisatoshiPerByte = BitcoinType.MillisatoshiPerByte;
  type GetBalanceRequest = BitcoinType.GetBalanceRequest;
  type GetUtxosRequest = BitcoinType.GetUtxosRequest;
  type GetCurrentFeePercentilesRequest = BitcoinType.GetCurrentFeePercentilesRequest;
  type SendTransactionRequest = BitcoinType.SendTransactionRequest;
