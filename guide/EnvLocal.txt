...
module Env {
  ...
  public let beamEscrowCanisterId = "rno2w-sqaaa-aaaaa-aaacq-cai";

  // Monitor Agent Canister ID
  public let monitorAgentCanisterId = "rdmx6-jaaaa-aaaaa-aaadq-cai";

  // Beam Canister ID
  public let beamCanisterId = "renrk-eyaaa-aaaaa-aaada-cai";
